...
describe('Storage', () => {
    ...
    it('should set items in storage', () => {
        ...
        expect(localStorage.setItem).toHaveBeenCalledWith(LOCAL_STORAGE_KEY, JSON.stringify(categoryArray));
    });
    ...
    it('should retrieve stored data from storage', () => {
        const categoryArray = [{ id: 1, name: 'Test Todo', tasks: [], taskRatio: [] }];
